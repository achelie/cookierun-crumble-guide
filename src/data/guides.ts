...
export const guides: GuideSummary[] = [
  {
    ...
    toc: [
      ...
      { id: "universal-stats", label: "Keep the safest general stats" },
      { id: "support-runes", label: "Build support Sugar Runes" },
      { id: "dps-runes", label: "Build DPS Sugar Runes" },
      { id: "tank-runes", label: "Build tank Sugar Runes" },
      { id: "focus-debuffers", label: "Use Focus on debuffers" },
      { id: "plating-priority", label: "Choose Plating upgrades" },
      { id: "reroll-budget", label: "Control the reroll budget" },
