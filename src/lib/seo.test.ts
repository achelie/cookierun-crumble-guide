...
describe("SEO page registry", () => {
  ...
  it("exposes the Teams update date in search-facing copy", () => {
    expect(seoPages.teams.summary).toContain("Updated September 6, 2026");
    expect(seoPages.teams.description).toContain("Updated September 6, 2026");
    expect(seoPages.teams.updatedAt).toBe("2026-09-06");
  });
});
