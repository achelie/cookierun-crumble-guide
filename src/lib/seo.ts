...
export const seoPages = {
  ...
  teams: {
    ...
    summary: `Copy ${recommendedTeams.length} teams for Brightseeker stage pushes, F2P progression, bosses, tower floors, and daily dungeons.`,
    description: "Copy CookieRun: Crumble best teams for Brightseeker stage pushes, F2P progression, bosses, tower floors, and daily dungeons, with Pets and Synergy.",
    breadcrumb: "Teams",
